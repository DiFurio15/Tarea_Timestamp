...
public class Timestamp {
     ...
     * Inicializa la fecha y hora al comienzo de la era Unix (1 de enero de 1970, 00:00:00 GMT).
     */
    ...
    private boolean esFechaValida(int año, int mes, int dia) {
        if (año < 1 || mes < 1 || mes > 12 || dia < 1 || dia > getDiasDelMes(mes, año)) {//* Valida si la combinación de año, mes y día representa una fecha válida.
            return false;
        }
        return true;
    }
    ...
    private boolean esHoraValida(int hora, int minuto, int segundo) {
        if (hora < 0 || hora > 23 || minuto < 0 || minuto > 59 || segundo < 0 || segundo > 59) {//Valida si la combinación de hora, minuto y segundo representa una hora válida.

            return false;
        }//si la hora es válida, false en caso contrario.
        return true;
    }
}
